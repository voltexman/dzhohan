...
class CreateAdmin extends Command
{
    ...
    public function handle()
    {
        ...
        Setting::firstOrCreate(['id' => 1], [
            ...
            'faqs' => [
                [
                    'question' => 'Яку сталь ви використовуєте для своїх ножів?',
                    'answer' => 'Я працюю з різними типами сталей залежно від призначення ножа: від перевірених часом вуглецевих сталей до сучасних порошкових нержавіючих сталей (наприклад, M390, Elmax, N690). Кожен клинок проходить індивідуальну термічну обробку для досягнення оптимального балансу між твердістю та в\'язкістю.',
                ],
                [
                ...
                [
                    'question' => 'Як правильно доглядати за авторським ножем?',
                    'answer' => 'Після кожного використання ніж слід ретельно вимити вручну (не в посудомийній машині!) та витерти насухо. Якщо ніж виготовлений з вуглецевої сталі, рекомендую періодично змащувати клинок тонким шаром гвоздичної або звичайної мінеральної олії для захисту від корозії.',
                ],
                [
                ...
                [
                    'question' => 'Які матеріали ви використовуєте для руків\'я?',
                    'answer' => 'Використовую як натуральні матеріали (стабілізована деревина екзотичних порід, кап, ріг), так і сучасні композити (G10, мікарта, карбон). Всі матеріали підбираються з урахуванням ергономіки та стійкості до зовнішнього середовища.',
                ],
                [
                ...
                [
                    'question' => 'Як заточувати ніж вашої роботи?',
                    'answer' => 'Я віддаю ножі з професійною бритвеною заточкою. Для підтримки гостроти рекомендую використовувати керамічні мусати або якісні точильні камені. Якщо ви не впевнені у своїх навичках, ви завжди можете надіслати ніж мені на обслуговування.',
                ],
                [
