...
*/
    $base =
        'inline-flex items-center justify-center font-medium transition rounded-md border border-transparent duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer';
...
*/
    $colors = [
        'dark' => [
            ...
            'soft' => 'bg-zinc-200 text-zinc-600 hover:bg-zinc-300 hover:text-zinc-900 focus-visible:ring-black',
