@props([
    'icon' => null,
    'size' => 'lg', // sm, md, lg
    'color' => 'dark', // dark (для білого фону), light (для темного/скла)
])
...
@php
    ...
    */
    ...
    $baseClass =
        'font-[SN_Pro] border rounded-md w-full transition-all duration-250 focus:outline-none focus:ring-4 focus:ring-offset-0';
